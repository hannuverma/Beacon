...
import { Events, UserProfile, Location } from '../types';
import { Power, BarChart3, Plus, Settings, Users, Calendar, Store, X, MapPin } from 'lucide-react';
...
const EventPanel: React.FC<EventPanelProps> = ({ events, user, draftLocation, onSetDraftLocation, onToggleStatus, onCreateEvent, onEventCreated }) => {
...
>
  ...
  Host New
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar" style={{ padding: '1.5rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
          <div style={{ background: 'rgba(255,255,255,0.03)', padding: '1rem', borderRadius: '1.25rem', border: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            <p style={{ fontSize: '1.5rem', fontWeight: 'bold', color: 'white', margin: 0 }}>{myEvent.expectedPurchases}</p>
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          <div className="flex justify-between items-center" style={{ marginBottom: '0.75rem' }}>
            ...
            <button 
              onClick={() => setShowCreateForm(true)}
              style={{ background: 'transparent', border: 'none', color: 'var(--purple)', fontSize: '0.75rem', fontWeight: 'bold', display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
      ...
      <div style={{ padding: '1rem', borderTop: '1px solid var(--border)', textAlign: 'center' }}>
        <p style={{ fontSize: '0.625rem', color: 'var(--text-muted)', margin: 0 }}>Location verified: {myEvent?.location?.address || "No address provided"}</p>
      </div>
